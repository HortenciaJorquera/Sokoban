class Player {
  ...
  moveUp(nextSquare) {
    ...
    if (
      typeof nextSquare === "object" &&
      game.nextSquare(nextSquare.row - 1, nextSquare.col) !== "wall" &&
      typeof game.nextSquare(nextSquare.row - 1, nextSquare.col) !== "object"
    ) {
      this.old[0] = this.row;
      this.row--;
  ...
  moveRight(nextSquare) {
    ...
    if (
      typeof nextSquare === "object" &&
      game.nextSquare(nextSquare.row, nextSquare.col + 1) !== "wall" &&
      typeof game.nextSquare(nextSquare.row, nextSquare.col + 1) !== "object"
    ) {
      this.old[1] = this.col;
      this.col++;
